...
namespace ComparePG
{
    ...
    public class ItemComparable
    {
        ...
        public string TableName { get { return UppercaseFormattedValue(this[Constants.TABLE_NAME]); } }

        public string Name { get { return UppercaseFormattedValue(this[Constants.ELEMENT_NAME]); } }
